...
class CustomUser(AbstractBaseUser):
    ...
    """
    first_name = models.CharField(max_length=20, default="undefined")
    last_name = models.CharField(max_length=20, default="undefined")
    middle_name = models.CharField(max_length=20, default="undefined")
    ...
    def __str__(self):
        ...
        """
        return f"{self.get_role_name()} {self.first_name}({self.email})"
    ...
    @staticmethod
    def create(email, password, first_name='unknown', middle_name='unknown', last_name='unknown'):
        """
